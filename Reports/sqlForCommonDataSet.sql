...
--	t.dtStart,
--	AKAR2.FE as AKAR2,
--	KAR30_6.FE as KAR30_6 
--FROM [v_GasCollectionData] t
--LEFT JOIN [v_GasCollectionData] AKAR2 ON AKAR2.IDeq = 10180 AND t.dtStart=AKAR2.dtStart
--LEFT JOIN [v_GasCollectionData] KAR30_6 ON KAR30_6.IDeq = 10071 AND t.dtStart=KAR30_6.dtStart
--WHERE t.dtEnd BETWEEN '2016-12-21 09:00' AND '2016-12-21 10:59'
--GROUP BY  t.dtStart,  AKAR2.FE,  KAR30_6.FE