SELECT TOP 1
	...
	--FE3.23_norm
	FE323_norm.Value as FE323_norm, PE325.Value as PE325, TE323.Value as TE323,
	--FE3.26_norm
	FE326_norm.Value as FE326_norm, PE328.Value as PE328, TE326.Value as TE326,
	--FE3.27_norm
	FE327_norm.Value as FE327_norm, PE329.Value as PE329, TE327.Value as TE327,

	--Olvia aka KRP-2 aka HES
	--FE1a1_norm
	FE1a1_norm.Value as FE1a1_norm, PE4a1.Value as PE4a1, TE1a1.Value as TE1a1, QE1a1.Value as QE1a1,
	--FE1a2_norm
	FE1a2_norm.Value as FE1a2_norm, PE4a2.Value as PE4a2, TE1a2.Value as TE1a2, QE1a1.Value as QE1a2
...
FROM [dbo].[CurData] t
	...
	LEFT JOIN [dbo].[CurData] PE325 ON PE325.ID = 134
	LEFT JOIN [dbo].[CurData] TE323 ON TE323.ID = 135
	LEFT JOIN [dbo].[CurData] FE323_norm ON FE323_norm.ID = 138

	LEFT JOIN [dbo].[CurData] PE328 ON PE328.ID = 199
	LEFT JOIN [dbo].[CurData] TE326 ON TE326.ID = 200
	LEFT JOIN [dbo].[CurData] FE326_norm ON FE326_norm.ID = 202

	LEFT JOIN [dbo].[CurData] PE329 ON PE329.ID = 204
	LEFT JOIN [dbo].[CurData] TE327 ON TE327.ID = 205
	LEFT JOIN [dbo].[CurData] FE327_norm ON FE327_norm.ID = 207

	LEFT JOIN [dbo].[CurData] PE4a1 ON PE4a1.ID = 219
	LEFT JOIN [dbo].[CurData] TE1a1 ON TE1a1.ID = 220
	LEFT JOIN [dbo].[CurData] QE1a1 ON QE1a1.ID = 221
	LEFT JOIN [dbo].[CurData] FE1a1_norm ON FE1a1_norm.ID = 222

	LEFT JOIN [dbo].[CurData] PE4a2 ON PE4a2.ID = 224
	LEFT JOIN [dbo].[CurData] TE1a2 ON TE1a2.ID = 225
	LEFT JOIN [dbo].[CurData] QE1a2 ON QE1a2.ID = 226
	LEFT JOIN [dbo].[CurData] FE1a2_norm ON FE1a2_norm.ID = 227
...
GROUP BY
	...
	FE323_norm.Value, PE325.Value, TE323.Value,
	FE326_norm.Value, PE328.Value, TE326.Value,
	FE327_norm.Value, PE329.Value, TE327.Value,
	FE1a1_norm.Value, PE4a1.Value, TE1a1.Value, QE1a1.Value,
	FE1a2_norm.Value, PE4a2.Value, TE1a2.Value, QE1a2.Value