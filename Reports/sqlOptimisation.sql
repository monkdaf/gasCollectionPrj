...
WHERE sr.ActualStartTime >= '2017-02-07 19:00:00' AND sr.ActualStartTime <= '2017-02-08 18:59:00'
--order by dtStart;
GO
...
FROM [testView] t
LEFT JOIN [testView] CPSetc ON CPSetc.IDeq = 10113 AND t.dtStart=CPSetc.dtStart
LEFT JOIN [testView] DP9etc ON DP9etc.IDeq = 10117 AND t.dtStart = DP9etc.dtStart
LEFT JOIN [testView] SPC1etc ON SPC1etc.IDeq = 10121 AND t.dtStart = SPC1etc.dtStart
